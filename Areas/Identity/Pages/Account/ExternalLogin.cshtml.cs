...
namespace midterm_project.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        // ✅ Improved handler for "Cancel" or remote errors
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            returnUrl = returnUrl ?? Url.Content("~/");

            // ✅ Gracefully handle cancel/denial or any remote error
            if (remoteError != null)
            {
                _logger.LogWarning("External login failed: {Error}", remoteError);
                ErrorMessage = "You canceled or denied the external login process.";
